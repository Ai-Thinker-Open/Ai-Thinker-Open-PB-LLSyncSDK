...
#define AI_THINKER_PB_02_KIT_GREEN_PIN     (P15)
#define AI_THINKER_PB_02_KIT_BLUE_PIN      (P18)
#define AI_THINKER_PB_02_KIT_CW_PIN     (P34)
#define AI_THINKER_PB_02_KIT_WW_PIN      (P0)
#define GPIO_GREEN      AI_THINKER_PB_02_KIT_GREEN_PIN
#define GPIO_BLUE     AI_THINKER_PB_02_KIT_BLUE_PIN
#define GPIO_RED      AI_THINKER_PB_02_KIT_RED_PIN
