...
int hal_pwrmgr_lock_modify(MODULE_e mod)
{
    mPwrMode = PWR_MODE_NO_SLEEP;
...
int hal_pwrmgr_unlock_modify(MODULE_e mod)
{
    mPwrMode = PWR_MODE_SLEEP;
