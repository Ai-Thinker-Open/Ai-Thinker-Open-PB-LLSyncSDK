...
// use the macro if the tencent lianlian SDK code is modified 
#define AITHINKER_AT_MODIFY  1
#if AITHINKER_AT_MODIFY
...
// timestamp
#define BLE_QIOT_LOG_PRINT(...) LOG(__VA_ARGS__)
...
#define BLE_QIOT_LLSYNC_STANDARD    1   // support llsync standard
    ...
    #define BLE_QIOT_RECORD_FLASH_ADDR USER_QIOT_RECORD_FLASH_ADDR
    ...
    #define BLE_QIOT_USER_DEVELOPER_VERSION USER_VERSION
    ...
    #define BLE_QIOT_SUPPORT_OTA 1  // 1 is support ota, others not
        ...
        #define BLE_QIOT_SUPPORT_RESUMING 0  // 1 is support resuming, others not
            ...
            #define BLE_QIOT_OTA_INFO_FLASH_ADDR USER_QIOT_OTA_INFO_FLASH_ADDR
        #endif //BLE_QIOT_SUPPORT_RESUMING

        #define BLE_QIOT_TOTAL_PACKAGES 0x80  // the total package numbers in a loop
        #define BLE_QIOT_PACKAGE_LENGTH 0x40  // the user data length in package, ble_get_user_data_mtu_size() - 3 is the max
        ...
        #define BLE_QIOT_REBOOT_TIME      60
        #define BLE_QIOT_PACKAGE_INTERVAL 0x20  // the interval between two packages send by the server
