...
enum {
	...
	BLE_QIOT_PROPERTY_ID_WORK_MODE,
	BLE_QIOT_PROPERTY_ID_HSV_COLOR,
	BLE_QIOT_PROPERTY_ID_BRIGHTNESS,
	BLE_QIOT_PROPERTY_ID_COLOR_TEMP,
	BLE_QIOT_PROPERTY_ID_SCENE,
	BLE_QIOT_PROPERTY_ID_COLOR_VALUE,
	BLE_QIOT_PROPERTY_ID_COUNT_DOWN,
	BLE_QIOT_PROPERTY_ID_NAME,
	BLE_QIOT_PROPERTY_ID_BUTT,
};

// define work_mode enum
enum {
	BLE_QIOT_PROPERTY_WORK_MODE_°×¹â = 0,
	BLE_QIOT_PROPERTY_WORK_MODE_²Ê¹â = 1,
	BLE_QIOT_PROPERTY_WORK_MODE_³¡¾° = 2,
	BLE_QIOT_PROPERTY_WORK_MODE_BUTT,
};

// define hsv_color hue attributes
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_HUE_MIN	(0)
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_HUE_MAX	(360)
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_HUE_START	(0)
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_HUE_STEP	(0.01)
// define hsv_color saturation attributes
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_SATURATION_MIN	(0)
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_SATURATION_MAX	(100)
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_SATURATION_START	(0)
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_SATURATION_STEP	(1)
// define hsv_color value attributes
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_VALUE_MIN	(0)
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_VALUE_MAX	(100)
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_VALUE_START	(0)
#define BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_VALUE_STEP	(1)
// define hsv_color property id
enum {
	BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_ID_HUE,
	BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_ID_SATURATION,
	BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_ID_VALUE,
	BLE_QIOT_STRUCT_HSV_COLOR_PROPERTY_ID_BUTT,
};
...
#define BLE_QIOT_PROPERTY_COLOR_TEMP_MIN	(2000)
#define BLE_QIOT_PROPERTY_COLOR_TEMP_MAX	(7000)
#define BLE_QIOT_PROPERTY_COLOR_TEMP_START	(0)
#define BLE_QIOT_PROPERTY_COLOR_TEMP_STEP	(1)
// define scene enum
enum {
	BLE_QIOT_PROPERTY_SCENE_¹¤×÷ = 0,
	BLE_QIOT_PROPERTY_SCENE_ÔÄ¶Á = 1,
	BLE_QIOT_PROPERTY_SCENE_Ë¯Ãß = 2,
	BLE_QIOT_PROPERTY_SCENE_ÐÝÏÐ = 3,
	BLE_QIOT_PROPERTY_SCENE_ÈáºÍ = 4,
	BLE_QIOT_PROPERTY_SCENE_BUTT,
};

// define color_value length limit
#define BLE_QIOT_PROPERTY_COLOR_VALUE_LEN_MIN	(0)
#define BLE_QIOT_PROPERTY_COLOR_VALUE_LEN_MAX	(20)
// define count_down attributes
#define BLE_QIOT_PROPERTY_COUNT_DOWN_MIN	(0)
#define BLE_QIOT_PROPERTY_COUNT_DOWN_MAX	(86400)
#define BLE_QIOT_PROPERTY_COUNT_DOWN_START	(0)
#define BLE_QIOT_PROPERTY_COUNT_DOWN_STEP	(1)
